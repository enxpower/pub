  ...
  const stores = [
    {
      ...
      demand: '游客刚进入栈道时，首先面临体力补给、天气应对与拍照准备等需求。该点位应以易于即时购买的商品促成首次消费，并建立对“寻美栈道”的第一重记忆。',
      products: ['雷山银球风味茶', '西江苗家风味冰浆', '能量补给食品', '苗寨地标冰箱贴', '防雨御寒装备', '手机摄影配件与滤镜', '寻美栈道印章打卡本'],
      ...
      strategy: '优先保障出品速度、天气应急商品与轻量文创的陈列和选购效率，将其打造为全线客流转化的起点。',
    },
    {
      n: '02',
      name: '深山茶室',
      ...
      demand: '游客完成第一段登高后，需要短暂停留、恢复体力并安静观景。小体量空间不宜配置复杂菜单，更适合以少量高辨识度产品承接休憩与观景需求。',
      products: ['贵州抹茶风味茶饮', '苗家精致茶点', '抹茶生活方式产品', '千户苗寨全景小夜灯'],
      features: ['空间表达强调静谧、留白和自然材质', '设置面向苗寨的核心观景座位', '包装采用低饱和苗岭色系，突出深山茶室气质'],
      value: '以景观与静谧氛围形成价值感，在有限面积内提供高品质茶歇体验并实现稳定消费。',
      strategy: '控制SKU数量，以标准化程度高、出品稳定、视觉呈现统一的茶饮与点心为主，降低后场运营压力。',
    },
    {
      n: '03',
      name: '万物有灵',
      ...
      products: ['地标冰箱贴与透卡', '银饰、刺绣、蜡染', '贵州茶、苗族草本产品、苗寨零食', '护手霜、香氛等日化', '苗族风格时尚单品', '黄小西西江限定系列'],
      features: ['建立统一的西江限定产品视觉系统', '把非遗从陈列品转译为日常可用的生活方式商品', '设置限定首发、联名发布和直播展示区'],
      value: '成为全线品牌旗舰、限定首发地与高价值文创消费中心。',
      strategy: '按“入门小件、核心限定、高价值联名、线上复购”组织货架，使空间同时服务现场销售与内容电商。',
    },
    {
      n: '04',
      name: '种子暗光',
      ...
      demand: '栈道中段需要一处兼具鲜明记忆点与传播力的沉浸空间。苗族神话、种子与祈福意象，能够将咖啡消费转化为可参与、可讲述的文化体验。',
      products: ['苗家特色风味咖啡', '暗色主题限定包装', '苗家特色甜品', '苗疆种子祈福盲盒'],
      features: ['暗光、局部照明和神话纹样形成可识别氛围', '祈福盲盒和互动装置提供参与感', '适合短视频拍摄的低照度视觉场景'],
      value: '承担文化沉浸、夜游记忆和主题零售三重价值。',
      strategy: '以少量主题鲜明的产品和稳定的灯光氛围建立传播记忆点，避免过重装置增加运营维护负担。',
    },
    {
      n: '05',
      name: '云上咖啡',
      ...
      features: ['面向苗寨设置核心全景座席', '白天咖啡、夜间酒饮双场景切换', '与优质主理人开展联名合作，提升空间调性'],
      value: '依托景观价值与夜间消费提升整体消费贡献，并延长游客在高点的停留时间。',
      strategy: '将窗口座位、外摆秩序、饮品视觉呈现与夜间灯光效果作为核心运营指标。',
    },
    {
      n: '06',
      name: '苗家的茶',
      ...
      demand: '游客对“苗家草本”和地方生活方式充满好奇，需要通过日常饮品与伴手礼建立直观认知，并避免医疗化表达。',
      products: ['百草苗茶', '刺梨折耳根草本饮', '益肝草凉茶', '藤茶', '木姜子青草饮', '青橄榄润喉饮', '苗疆草本日化'],
      features: ['在地居民参与传统配方整理与讲述', '设置草本原料展示和知识说明', '突出文化、风味和日常饮用体验'],
      value: '将本地草本知识转化为日常茶饮与可复购的伴手礼。',
      strategy: '建立合规的产品命名、内容表达与服务说明体系，优先选择品质稳定、易于标准化的草本饮品。',
    },
    {
      n: '07',
      name: '非遗工坊',
      ...
      features: ['可视化手作台和小型体验课程', '优先与西江本地居民和手艺人合作', '让制作过程本身成为可观看、可参与、可传播的内容场景'],
      value: '提升非遗活化水平、社区收益、游客参与度与内容生产能力。',
      strategy: '将预约体验与即购型小件相结合，确保小面积空间也能稳定承接游客参与与商品销售。',
    },
    {
      n: '08',
      name: '蝶泉蜜语',
      ...
      value: '连接雷山蜂产业，形成小体量、可复购的特色零售节点。',
      strategy: '通过标准化小包装与组合礼盒提升组合购买率，并以试吃试饮降低购买门槛。',
    },
    {
      n: '09',
      name: '苗境幻影',
    ...
    },
    {
      ...
      demand: '终点需要将整条栈道体验收束为一段可以坐下来慢慢感受的风景消费，轻餐、慢酒与夜景能够自然延长停留。',
      products: ['黑毛猪与小黄牛汉堡', '苗寨沙拉', '苗寨腊味拼盘', '行匠精酿', '抹茶精酿', '苗寨米酒', '苗寨限定特调'],
      features: ['以窗景和外摆组织终点停留', '菜单强调当地食材的现代化表达', '灯光、诗句和夜景形成夜间记忆'],
      value: '以餐饮消费与夜游停留完成全线商业叙事闭环。',
      strategy: '控制菜单复杂度，强化本地食材与夜间氛围，让终点成为值得再次到访的慢生活空间。',
    },
  ].map((store, index) => ({
    ...store,
      ...
      <article class="proposal-document" role="document">
        <section class="proposal-hero">
          <div class="proposal-visual">
            <img src="${store.images[0]}" alt="${esc(store.name)}空间概念主图" loading="eager">
          ...
          <div class="proposal-image-grid">
            ${store.images.map((src, imageIndex) => `
              <figure class="proposal-image">
                <img src="${src}" alt="${esc(store.name)}空间与产品概念图 ${imageIndex + 1}" loading="${imageIndex ? 'lazy' : 'eager'}">
